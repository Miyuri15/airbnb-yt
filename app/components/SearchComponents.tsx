                ...
                <form className="gap-4 flex flex-col ">
                    ...
                    {step === 1 ? (
                        ...
                        <DialogHeader>
                            ...
                            <DialogDescription>Please choose a country so that we know what you want</DialogDescription>
                        </DialogHeader>
                    ...
                    <CardHeader className="flex flex-col gap-y-5">
                        <div className="flex items-center justify-between">
                            <div className="flex flex-col">
                                <h3 className="underline text-medium">Guests</h3>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex flex-col">
                                <h3 className="underline text-medium">Rooms</h3>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex flex-col">
                                <h3 className="underline text-medium">Bathrooms</h3>
